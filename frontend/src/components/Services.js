...
import { GitBranch, Code, Container, Activity, Brain, RefreshCw, Database, Workflow, ArrowRight, Sparkles } from 'lucide-react';
    ...
    <section id="services" className="py-20 bg-gradient-to-br from-[rgb(17,17,19)] to-[rgb(26,28,30)] relative overflow-hidden">
      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="text-center mb-16">
          <div className="inline-flex items-center space-x-2 bg-[rgb(26,28,30)] px-4 py-2 rounded-full mb-8 border border-[rgb(63,63,63)] hover:border-[rgb(218,255,1)] transition-all duration-500 hover:scale-105 group animate-fadeIn">
          ...
          <p className="text-xl text-[rgb(161,161,170)] max-w-3xl mx-auto animate-fadeInUp animation-delay-200">
        ...
        <div className="mb-20">
          <div className="text-center mb-12">
            <h3 className="text-3xl font-bold text-white mb-4 animate-slideInFromLeft">{services.devops.title}</h3>
            <p className="text-lg text-[rgb(161,161,170)] max-w-2xl mx-auto animate-slideInFromRight">{services.devops.description}</p>
          </div>
          
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {services.devops.items.map((service, index) => {
              const IconComponent = iconMap[service.icon];
              return (
                <Card key={service.id} className="bg-gradient-to-br from-[rgb(26,28,30)] to-[rgb(38,40,42)] border-[rgb(63,63,63)] hover:border-[rgb(218,255,1)] transition-all duration-500 hover:transform hover:-translate-y-4 hover:scale-105 group interactive-card animate-fadeInUp" style={{ animationDelay: `${index * 100}ms` }}>
                  ...
                  <CardContent>
                    <CardDescription className="text-[rgb(161,161,170)] mb-6 leading-relaxed group-hover:text-[rgb(218,218,218)] transition-colors duration-300">
                      {service.description}
                    </CardDescription>
        ...
        <div className="mb-20">
          <div className="text-center mb-12">
            <h3 className="text-3xl font-bold text-white mb-4 animate-slideInFromRight">{services.mlops.title}</h3>
            <p className="text-lg text-[rgb(161,161,170)] max-w-2xl mx-auto animate-slideInFromLeft">{services.mlops.description}</p>
          </div>
          
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {services.mlops.items.map((service, index) => {
              const IconComponent = iconMap[service.icon];
              return (
                <Card key={service.id} className="bg-gradient-to-br from-[rgb(26,28,30)] to-[rgb(38,40,42)] border-[rgb(63,63,63)] hover:border-[rgb(218,255,1)] transition-all duration-500 hover:transform hover:-translate-y-4 hover:scale-105 group interactive-card animate-fadeInUp" style={{ animationDelay: `${(index + 4) * 100}ms` }}>
                  <CardHeader className="pb-4">
                    <div className="w-14 h-14 bg-[rgb(218,255,1)]/10 rounded-xl flex items-center justify-center mb-4 group-hover:bg-[rgb(218,255,1)]/20 transition-all duration-500 group-hover:scale-110 group-hover:rotate-12">
                      <IconComponent className="w-7 h-7 text-[rgb(218,255,1)] group-hover:animate-pulse" />
                    </div>
        ...
        <div className="bg-gradient-to-r from-[rgb(26,28,30)] to-[rgb(38,40,42)] rounded-2xl p-8 md:p-12 border border-[rgb(63,63,63)] hover:border-[rgb(218,255,1)] transition-all duration-500 relative overflow-hidden group">
          ...
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-[rgb(161,161,170)] max-w-2xl mx-auto animate-fadeInUp animation-delay-200">
